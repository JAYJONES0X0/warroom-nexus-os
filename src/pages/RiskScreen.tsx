  ...
  return (
    ...
    >
      ...
      <div className="glass-card p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="glass-card p-4 rounded-xl bg-red-500/[0.03] border border-red-500/10 text-center">
          ...
          <div className="glass-card p-4 rounded-xl bg-emerald-500/[0.03] border border-emerald-500/10 text-center">
