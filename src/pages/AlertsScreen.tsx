  ...
  return (
    ...
    >
      ...
      <div className="space-y-2.5">
        {alerts.map((a) => (
          <div key={a.id} className={`flex items-center justify-between p-5 transition-all glass-card${a.status === "TRIGGERED" ? " glass-card-amber" : ""}`} style={{
            borderColor: a.status === "TRIGGERED" ? "rgba(255,136,0,0.4)" : a.status === "DISMISSED" ? "rgba(255,255,255,0.03)" : undefined,
